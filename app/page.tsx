        ...
        <header className="relative z-10 border-b border-gray-200/30 backdrop-blur-sm">
          ...
          <nav className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center space-x-8">
              ...
              <Link href="/intermittent-fasting" className="text-gray-700 hover:text-teal-600 transition font-medium">
                IF Plans
              </Link>
              <Link href="/mediterranean" className="text-gray-700 hover:text-teal-600 transition font-medium">
                Mediterranean
              </Link>

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        ...
        {/* Header */}
        <header className="relative z-10 border-b border-gray-200/30 backdrop-blur-sm">
          ...
          <nav className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[100]">
                  <div className="py-2">

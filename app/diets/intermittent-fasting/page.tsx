...
import { Clock, Zap, Brain, TrendingDown, Check } from 'lucide-react'
      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="text-center bg-gradient-to-br from-amber-50/60 to-orange-50/60 backdrop-blur-sm rounded-2xl p-8"
          >

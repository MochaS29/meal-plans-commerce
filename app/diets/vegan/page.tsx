    ...
    <div className="min-h-screen relative">
      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="bg-emerald-50/80 backdrop-blur-sm rounded-2xl p-6">
            ...
            <div className="bg-amber-50/80 backdrop-blur-sm rounded-2xl p-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-emerald-50/80 to-green-50/80 backdrop-blur-sm rounded-2xl p-8 mb-12"
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">

      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-green-50/60 to-emerald-50/60 backdrop-blur-sm rounded-2xl p-8 mb-12"
          >
          ...
          >
            <div className="bg-green-50/60 backdrop-blur-sm rounded-2xl p-6">
            ...
            <div className="bg-red-50/60 backdrop-blur-sm rounded-2xl p-6">

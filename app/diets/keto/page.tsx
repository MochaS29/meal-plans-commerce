...
import { Zap, Brain, TrendingDown, Flame, Check, ShoppingCart } from 'lucide-react'
      ...
      <div className="relative z-20 sticky top-0 bg-white/95 backdrop-blur-md shadow-md py-3 px-6">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900">Keto Diet Plan</span>
          </div>
      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-green-50/40 to-emerald-50/40 backdrop-blur-sm rounded-2xl p-8 mb-12"
          >
          ...
          >
            <div className="bg-green-50/40 backdrop-blur-sm rounded-2xl p-6">
            ...
            <div className="bg-red-50/40 backdrop-blur-sm rounded-2xl p-6">

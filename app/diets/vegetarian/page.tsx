      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-green-50/80 to-lime-50/80 backdrop-blur-sm rounded-2xl p-8 mb-12"
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Complete Protein Sources</h2>
            <div className="grid md:grid-cols-2 gap-4">
              {proteinSources.map((source, idx) => (
                <div key={idx} className="flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-lg p-4">
          ...
          >
            ...
            <div className="space-y-4">
              {sampleMeals.map((item, idx) => (
                <div key={idx} className="bg-white/90 backdrop-blur-sm rounded-lg shadow-md p-6 hover:shadow-lg transition">

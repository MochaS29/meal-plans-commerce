      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              {cuisines.map((cuisine, idx) => (
                <div key={idx} className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 hover:shadow-lg transition">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-8 mb-12"
          >

      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              {cuisines.map((cuisine, idx) => (
                <div key={idx} className="bg-gradient-to-r from-indigo-50/80 to-purple-50/80 backdrop-blur-sm rounded-xl p-6 hover:shadow-lg transition">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-purple-50/80 to-indigo-50/80 backdrop-blur-sm rounded-2xl p-8 mb-12"
          >
